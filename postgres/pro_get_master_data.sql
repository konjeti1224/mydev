-- PROCEDURE: tenant_default.pro_get_master_data(text, text, text)

-- DROP PROCEDURE IF EXISTS tenant_default.pro_get_master_data(text, text, text);
...
END;
$BODY$;
ALTER PROCEDURE tenant_default.pro_get_master_data(text, text, text)
    OWNER TO dev_user;
